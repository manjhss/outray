...
export const ExpressHero = () => {
  ...
  const copyCommand = () => {
    navigator.clipboard.writeText("npm install @outray/express");
    setCopied(true);
    ...
    <div className="relative min-h-[80vh] flex flex-col justify-center items-center pt-32 pb-16 overflow-hidden">
      ...
      >
        ...
        <p className="text-xl md:text-2xl text-white/50 max-w-2xl mx-auto mb-10 leading-relaxed">
          The official OutRay plugin for Express. Automatically creates a public tunnel 
        ...
        >
          <span className="text-accent">$</span> npm install @outray/express
          {copied ? (
